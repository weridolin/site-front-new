<template>
  <div>
    <new-header
      class="siteHeader"
      v-show="$route.meta.header && !$route.path.includes('admin')"
    ></new-header>
    ...
    ></router-view>
    <index-footer
      v-show="$route.meta.footer && $route.path !== '/drug'"
    ></index-footer>
