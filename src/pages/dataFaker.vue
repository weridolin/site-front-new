...
<el-container   
    ...
    <el-main>
        <el-form :model="dynamicValidateForm" ref="dynamicValidateFormR" label-width="100px" class="demo-dynamic">
            <el-form-item
    ...
    <el-footer>
        ...
        <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
            ...
            <el-button @click="addDomain"><el-icon style="vertical-align: middle"><CirclePlus /></el-icon><span>新增</span></el-button>
