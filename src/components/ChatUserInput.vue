...
<script>
import EmojiIcon from 'src/components/icons/EmojiIcon.vue'
import FileIcons from 'src/components/icons/FileIcons.vue'
import UserInputButton from 'src/components/ChatUserInputButton.vue'
import Suggestions from 'src/components/ChatSuggestions.vue'
import store from 'src/store/index.js'
import IconCross from 'src/components/icons/IconCross.vue'
import IconOk from 'src/components/icons/IconOk.vue'
import IconSend from 'src/components/icons/IconSend.vue'
  ...
  props: {
    icons: {
      ...
      default: function () {
        return {
          file: {
            img: "src/assets/chatIcons/file.svg",
            name: 'default'
          },
          closeSvg: {
            img: "src/assets/chatIcons/close.svg",
            name: 'default'
          }
        }
      }
