...
export class Apis extends ApiBase {
  ...
  public async getMenuDetail(id: number, params: RequestParams = {}) {
    let res = await this.get<GetMenuDetailResponse>({
  ...
  public resetPwd(user_id:number,resetPwdForm:any,params:RequestParams={}){
    console.log(">>>>",resetPwdForm)
    let pwd = pwdEncrypt(resetPwdForm.new_password);
    return this.put<BaseResponse>({
